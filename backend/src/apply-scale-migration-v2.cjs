...
try {
  ...
  // 3. Создаём индексы для scale_jobs
  console.log("3️⃣ Создаю индексы для scale_jobs...");
  ...
  console.log("   ✅ Индексы для scale_jobs созданы\n");
  
  // 4. Создаём индексы для scaled_videos
  console.log("4️⃣ Создаю индексы для scaled_videos...");
  ...
  console.log("   ✅ Индексы для scaled_videos созданы\n");
